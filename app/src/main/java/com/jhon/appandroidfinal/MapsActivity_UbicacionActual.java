...
public class MapsActivity_UbicacionActual extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps__ubicacion_actual);
    ...
    private void agregarMarcador(double lat, double log) {
        ...
        marcador = mMap.addMarker(new MarkerOptions().position(coordenadas).title("Mi Posociòn Actual").icon(BitmapDescriptorFactory.fromResource(R.drawable.marcador)));
